...
export const BOUNTY_BALANCE = {
  ...
  TRIGGER_THRESHOLD: 0.3, // 30% of alive players
...
export const applyDifficultyScale = (difficulty: 'easy' | 'normal' | 'hard') => {
  switch (difficulty) {
    case 'easy': {
      RING_BALANCE.THRESHOLD_RING2 = 0.4;
      RING_BALANCE.THRESHOLD_RING3 = 0.6;
      BOSS_BALANCE.BOSS1_HEALTH = 400;
      BOSS_BALANCE.BOSS2_HEALTH = 600;
      break;
    }
    case 'hard': {
      RING_BALANCE.THRESHOLD_RING2 = 0.6;
      RING_BALANCE.THRESHOLD_RING3 = 0.8;
