...
export const createSynergyVisualEffect = (
  player: Player,
  config: {
    particleColor: string;
    particleCount: number;
...
export const TATTOO_SYNERGIES: TattooSynergy[] = [
  ...
  // BASIC SYNERGIES
  {
    ...
    effect: (player, state) => {
      ...
      createSynergyVisualEffect(
        player,
        { particleColor: '#E1BEE7', particleCount: 30, pattern: 'fusion', duration: 2.0 },
        state
      );
    },
  ...
  },
  {
    ...
    effect: (player, state) => {
      ...
      createSynergyVisualEffect(
        player,
        { particleColor: '#FF6B35', particleCount: 40, pattern: 'explosion', duration: 1.5 },
        state
      );
    },
    visualEffect: {
  ...
  // ADVANCED
  {
    ...
    effect: (player, state) => {
      ...
      createSynergyVisualEffect(
        player,
        { particleColor: '#FFD700', particleCount: 50, pattern: 'spiral', duration: 2.5 },
        state
      );
    },
  ...
  },
  {
    ...
    effect: (player, state) => {
      ...
      createSynergyVisualEffect(
        player,
        { particleColor: '#00BCD4', particleCount: 45, pattern: 'geometric', duration: 2.8 },
        state
      );
    },
    visualEffect: {
  ...
  },
  {
    ...
    effect: (player, state) => {
      ...
      createSynergyVisualEffect(
        player,
        { particleColor: '#F59E0B', particleCount: 40, pattern: 'geometric', duration: 2.2 },
        state
      );
    },
    visualEffect: {
  ...
  },
  {
    ...
    effect: (player, state) => {
      ...
      createSynergyVisualEffect(
        player,
        { particleColor: '#10B981', particleCount: 45, pattern: 'spiral', duration: 2.4 },
        state
      );
    },
  ...
  // MASTER
  {
    ...
    effect: (player, state) => {
      ...
      createSynergyVisualEffect(
        player,
        { particleColor: '#9C27B0', particleCount: 80, pattern: 'geometric', duration: 4.0 },
        state
      );
  ...
  },
  {
    ...
    effect: (player, state) => {
      ...
      createSynergyVisualEffect(
        player,
        { particleColor: '#FF5722', particleCount: 100, pattern: 'explosion', duration: 3.5 },
        state
      );
  ...
  },
  {
    ...
    effect: (player, state) => {
      ...
      createSynergyVisualEffect(
        player,
        { particleColor: '#EF4444', particleCount: 60, pattern: 'explosion', duration: 2.6 },
        state
      );
    },
    visualEffect: {
  ...
  // LEGENDARY
  {
    ...
    effect: (player, state) => {
      ...
      createSynergyVisualEffect(
        player,
        { particleColor: '#FFD700', particleCount: 150, pattern: 'geometric', duration: 5.0 },
        state
      );
  ...
  },
  {
    ...
    effect: (player, state) => {
      ...
      createSynergyVisualEffect(
        player,
        { particleColor: '#E91E63', particleCount: 120, pattern: 'spiral', duration: 4.5 },
        state
      );
