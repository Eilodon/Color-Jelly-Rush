  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/70 text-white">
      <div className="ritual-panel text-center">
        <div
          className={`ritual-title text-4xl sm:text-5xl mb-3 ${isWin ? 'text-[color:var(--gold-400)]' : 'text-[color:var(--blood-500)]'}`}
        >
        ...
        {isWin && canNext && (
          <button onClick={onNext} className="mt-4 ritual-button ritual-button-emerald text-xs">
            NEXT LEVEL
          </button>
        )}
      </div>
