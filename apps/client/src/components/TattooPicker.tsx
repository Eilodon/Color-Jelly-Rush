...
const tierColor = (tier: MutationTier) => {
  if (tier === MutationTier.Legendary)
    return 'text-yellow-300 border-yellow-500/50 shadow-yellow-500/20';
  if (tier === MutationTier.Epic)
    return 'text-purple-300 border-purple-500/50 shadow-purple-500/20';
  ...
  return (
    <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm animate-fadeIn">
      <div className="w-full max-w-5xl px-6">
        ...
        <p className="text-center text-[color:var(--mist-400)] mb-8 uppercase tracking-[0.3em] text-xs">
          Choose the mutation that defines your run
        </p>
