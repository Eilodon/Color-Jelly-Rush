/**
 * @cjr/engine - Level Configuration
 * Pure data definitions - no dependencies
 */
...
const tutorialLevels: LevelConfig[] = [
    {
        id: 1,
        name: 'Tutorial I',
        thresholds: { ring2: 0.38, ring3: 0.58, win: 0.84 },
        winHoldSeconds: 1.0,
        timeLimit: 180,
        waveIntervals: { ring1: 7.6, ring2: 9.8, ring3: 12.8 },
        burstSizes: { ring1: 30, ring2: 20, ring3: 15 },
    ...
    },
    {
        id: 2,
        name: 'Tutorial II',
        thresholds: { ring2: 0.42, ring3: 0.62, win: 0.86 },
        winHoldSeconds: 1.1,
        timeLimit: 170,
        waveIntervals: { ring1: 7.9, ring2: 10, ring3: 13.2 },
        burstSizes: { ring1: 25, ring2: 18, ring3: 12 },
    ...
    },
    {
        id: 3,
        name: 'Tutorial III',
        thresholds: { ring2: 0.48, ring3: 0.68, win: 0.88 },
        winHoldSeconds: 1.2,
        timeLimit: 160,
        waveIntervals: { ring1: 8.2, ring2: 10.3, ring3: 13.5 },
        burstSizes: { ring1: 20, ring2: 15, ring3: 10 },
    ...
    return {
        ...
        ring3Debuff: {
            ...
            speedMultiplier: lerp(
                level7Base.ring3Debuff.speedMultiplier,
                level10Target.ring3Debuff.speedMultiplier,
                t
            ),
        },
